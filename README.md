# Demo PHP Projects
This repository contains a list of demonstration applications. The demo applications have as a common factor the use of technologies based on PHP. Note that most of the published code is for academic purposes.
